...
#define GL_REPORT_STMT(type, func, ...)                                        \
  {                                                                            \
    OpenGLError ev(STR(type), STR(func), OpenGLError::type,                    \
                   OpenGLError::func);                                         \
    OpenGLError::sendEvent(&ev);                                               \
  }
#ifdef WIN32
#define GL_REPORT(type, func, ...)                                             \
  APPEND(GL_REPORT_STMT(type, func, __VA_ARGS__), )
#else
...
#define GL_DECL_5(fn, t0, t1, t2, t3, ...)                                     \
  inline bool fn(PDECL_4(t0, t1, t2, t3))
#define GL_DECL_6(fn, t0, t1, t2, t3, t4, ...)                                 \
  inline bool fn(PDECL_5(t0, t1, t2, t3, t4))
#define GL_DECL_7(fn, t0, t1, t2, t3, t4, t5, ...)                             \
  inline bool fn(PDECL_6(t0, t1, t2, t3, t4, t5))
#define GL_DECL_8(fn, t0, t1, t2, t3, t4, t5, t6, ...)                         \
  inline bool fn(PDECL_7(t0, t1, t2, t3, t4, t5, t6))
#define GL_DECL_9(fn, t0, t1, t2, t3, t4, t5, t6, t7, ...)                     \
  inline bool fn(PDECL_8(t0, t1, t2, t3, t4, t5, t6, t7))
#define GL_DECL_10(fn, t0, t1, t2, t3, t4, t5, t6, t7, t8, ...)                \
  inline bool fn(PDECL_9(t0, t1, t2, t3, t4, t5, t6, t7, t8))
#define GL_DECL_11(fn, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, ...)            \
  inline bool fn(PDECL_10(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9))
...
#define GL_CALL_I(n, caller, ...)                                              \
  APPEND(APPEND(GL_CALL_, n)(caller, __VA_ARGS__), )
#else
#define GL_DECL(...) APPEND(GL_DECL_, NARGS(__VA_ARGS__)(__VA_ARGS__))
#define GL_CALL(caller, ...)                                                   \
  APPEND(GL_CALL_, NARGS(__VA_ARGS__)(caller, __VA_ARGS__))
#endif
...
#define GL_CHECK(caller, ...)                                                  \
  GL_DECL(__VA_ARGS__) {                                                       \
    if (!GL_CALL(caller, __VA_ARGS__)) {                                       \
      GL_REPORT(caller, __VA_ARGS__);                                          \
      return false;                                                            \
    }                                                                          \
    return true;                                                               \
  }
